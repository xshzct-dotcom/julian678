  ...
  masonry.innerHTML = photos.map((p,i) => {
    ...
    return `<div class="masonry-item fade-up" data-idx="${i}">
      <div class="masonry-frame">
        <img src="${src}" alt="" decoding="async" onload="this.classList.add('loaded')" onerror="if(this.dataset.fb!=='1'){this.dataset.fb='1';this.src='${fb}';this.onerror=()=>{this.classList.add('loaded')}}" onclick="(function(t){var lb=document.getElementById('lightbox');lb.classList.add('active');lb.style.cssText='display:flex!important;opacity:1!important;pointer-events:auto!important;z-index:99999!important';document.body.style.overflow='hidden';var img=document.getElementById('lightboxImg');img.style.cssText='display:block;width:auto;height:auto;max-width:92vw;max-height:88vh;object-fit:contain;opacity:0;transition:opacity .25s ease';img.onload=function(){img.style.opacity='1'};img.onerror=function(){this.style.opacity='1'};img.src=t.src.replace('/thumbs/','/images/').replace('.webp','.jpg');})(this)">
      </div>
