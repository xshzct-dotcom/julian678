  ...
  masonry.innerHTML = photos.map((p,i) => {
    ...
    return `<div class="masonry-item fade-up" data-idx="${i}">
      <div class="masonry-frame">
        <img src="${src}" alt="" decoding="async" onload="this.classList.add('loaded')" onerror="if(this.dataset.fb!=='1'){this.dataset.fb='1';this.src='${fb}';this.onerror=()=>{this.classList.add('loaded')}}" onclick="(function(t){var lb=document.getElementById('lightbox');lb.style.cssText='display:flex!important;opacity:1!important;z-index:99999!important';document.body.style.overflow='hidden';var img=document.getElementById('lightboxImg');img.src=t.src.replace('/thumbs/','/images/').replace('.webp','.jpg');img.style.opacity='0';img.onload=function(){img.style.opacity='1'};document.getElementById('lightboxCounter').textContent='1 / 2652'})(this)">
      </div>
